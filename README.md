...
#### Кількість товару, отриманого кожним магазином

| Магазин    |   Загальний Потік (одиниць) |
|:-----------|----------------------------:|
| Магазин 1  |                          15 |
| Магазин 2  |                          10 |
| Магазин 3  |                           0 |
...
Застосований алгоритм Едмондса-Карпа гарантує знаходження оптимального потоку між одним джерелом та одним стоком, тож знайдений потік в 115 одиниць являється максимальним для заданої мережі.
...
2. Які маршрути мають найменшу пропускну здатність і як це впливає на загальний потік?
    ...
    Інші вузькі місця будуть описані в відповіді на питання 4.
